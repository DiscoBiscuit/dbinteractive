...
if(can_shoot()){
    firebullet(turretx+plane_x(48,0,turretang),turrety+plane_y(48,0,turretang),18,20,turretang-5,snd_laser,false,1)
    firebullet(turretx+plane_x(48,0,turretang),turrety+plane_y(48,0,turretang),18,20,turretang+5,-1,false,1)
