...
if(can_shoot()){
    firebullet(turretx+plane_x(48,0,turretang),turrety+plane_y(48,0,turretang),20,20,turretang,snd_laser,false,1)
    firebullet(turretx+plane_x(48,0,turretang),turrety+plane_y(48,0,turretang),20,20,turretang-10,-1,false,1)
    firebullet(turretx+plane_x(48,0,turretang),turrety+plane_y(48,0,turretang),20,20,turretang+10,-1,false,1)
