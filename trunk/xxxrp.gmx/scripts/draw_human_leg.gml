...
ass = spline_points( local_handle(thip,spline_handle(-32,-32,180+tthigh.ld,48)) , local_handle(tthigh,spline_handle(-32,48,180-tthigh.ld,48)) , 8)
...
thigh_front = spline_points( local_handle(tthigh,spline_handle(16,128,80,16)) , local_handle(tthigh,spline_handle(32,0,-60,32)) , 4)
