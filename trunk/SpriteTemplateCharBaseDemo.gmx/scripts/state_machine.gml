...
/*
if variable_local_exists('arg0')=0 arg0 = 0 //Use these variables if you want to pass arguments to your scripts,
if variable_local_exists('arg1')=0 arg1 = 0 //They will be cleared only when you change to a new state.
